...
import { Arrowhead, ChartType, ExcalidrawBindableElement, ExcalidrawElement, ExcalidrawElementType, ExcalidrawEmbeddableElement, ExcalidrawFrameLikeElement, ExcalidrawIframeElement, ExcalidrawLinearElement, ExcalidrawNonSelectionElement, FileId, FontFamilyValues, GroupId, NonDeleted, NonDeletedExcalidrawElement, OrderedExcalidrawElement, PointerType, StrokeRoundness, TextAlign, Theme } from "./types";
...
export type InteractiveCanvasAppState = Readonly<
  _CommonCanvasAppState & {
    ...
    // SnapLines
  // snapLines removed from AppState; keeping placeholder for future reinstatement
...
//   } | null;
  ...
  hoveredElementIds: { [id: string]: boolean };
