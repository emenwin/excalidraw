import type { IMAGE_MIME_TYPES, UserIdleState } from "@excalidraw/common";
import type {
  ExcalidrawElement,
  FileId,
...
import type { MakeBrand, ValueOf } from "@excalidraw/common/utility-types";
